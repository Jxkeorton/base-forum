...
const Locations = () => {
  ...
  const temporaryLocation = [
      { 
        ...
        "rock_drop": 328,
        "total_height": 328,
        "access": "0 minutes with shuttle: Park at the Tête de Chien panorama car park. The fairly obvious exit is only accessible from the fort which is unfortunately not accessible to the public... First locate the exit from the panorama.",
        "cliff_aspect": "SE",
        "opened_by": "Gillian Hamcy , David Degrado",
        "date_opened": "2018-12-30",
        "image": "https://res.cloudinary.com/dz02qubd3/image/upload/v1729441727/default_post_qpihoy.jpg",
        "is_saved": false
      },
      {
        "id": 1,
  ...
  return (
    <div>
      <h1>Locations</h1>
      <LocationList locations={temporaryLocation} />
    </div>
  )
}
